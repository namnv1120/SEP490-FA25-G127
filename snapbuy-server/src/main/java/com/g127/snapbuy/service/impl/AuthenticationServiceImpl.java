...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Override public AuthenticationResponse authenticate(AuthenticationRequest req){
    ...
    @Override public IntrospectResponse introspect(IntrospectRequest req){
        try{
        ...
        }catch(Exception e){ return IntrospectResponse.builder().valid(false).error("Invalid token").build(); }
    }
    @Override public AuthenticationResponse refreshToken(RefreshRequest req){
        try{
            String username = jwtUtil.extractUsername(req.getToken());
            UserDetails user = userDetailsService.loadUserByUsername(username);
        ...
        }catch(Exception e){ throw new BadCredentialsException("Invalid token"); }
    }
    @Override public void logout(LogoutRequest req){ /* no-op hiện tại */ }
}
