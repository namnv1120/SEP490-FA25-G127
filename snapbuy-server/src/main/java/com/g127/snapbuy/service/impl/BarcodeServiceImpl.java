...
public class BarcodeServiceImpl implements BarcodeService {
    ...
    public byte[] generateBarcodeImage(String barcode, int width, int height) throws IOException {
        ...
        try {
            ...
            // Tính toán kích thước cho text
            int textHeight = 35; // Tăng chiều cao cho text
            int fontSize = 16;
            int horizontalPadding = 10; // Padding ngang để text không bị cắt
            
            // Tạo image mới với chiều rộng lớn hơn để đảm bảo text không bị cắt
            // Thêm padding 2 bên cho text
            ...
            // Đảm bảo text không bị cắt - nếu text quá dài, scale font nhỏ hơn
