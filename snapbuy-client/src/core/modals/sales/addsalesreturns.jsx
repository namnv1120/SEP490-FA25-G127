...
const AddSalesReturns = ({ onSuccess }) => {
  // Form state
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formData = {
        ...
        paid: 0, // Default to 0, can be updated later
        due: calculateGrandTotal()
      };
      
      await salesReturnService.create(formData);
  ...
  // Handle add product (simplified - you can enhance this)
  const handleAddProduct = () => {
    ...
    // This is a simplified version. In real app, you would search product by code
    const newProduct = {
      id: Date.now().toString(),
      code: productCode,
      name: productCode, // In real app, fetch from API
      price: 0,
      qty: 1,
      discount: 0,
      tax: 0,
