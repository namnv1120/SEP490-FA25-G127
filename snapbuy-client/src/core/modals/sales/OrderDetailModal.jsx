  ...
  useEffect(() => {
    ...
    const fetchOrderDetail = async () => {
      ...
      try {
        ...
        // Ưu tiên sử dụng accountName từ orderDetail, sau đó từ accountNamesMap, cuối cùng mới fetch
        const accountId = data.accountId || data.createdById;
        if (data.accountName) {
          setCreatorName(data.accountName);
        } else if (accountId && accountNamesMap[accountId]) {
